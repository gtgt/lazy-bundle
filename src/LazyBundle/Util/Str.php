...
final class Str {
    ...
    public static function asRoutePath(string $value): string {
        return '/'.str_replace('_', '/', self::asSnakeCase($value));
    }
    ...
    public static function asFilePath(string $value): string {
        $value = Container::underscore(static::unaccent(trim($value)));
        $value = strtr(['\\' => '/', ' ' => '_'], $value);
    ...
    public static function getRandomTerm(): string {
        $adjectives = ['tiny', 'delicious', 'gentle', 'agreeable', 'brave', 'orange', 'grumpy', 'fierce', 'victorious',];
        $nouns = ['elephant', 'pizza', 'jellybean', 'chef', 'puppy', 'gnome', 'kangaroo',];
    ...
    public static function unaccent($string) {
        ...
        if (self::seemsUtf8($string)) {
            $chars = [// Decompositions for Latin-1 Supplement
                      ...
                      chr(194).chr(163) => '', 'Ä' => 'Ae', 'ä' => 'ae', 'Ü' => 'Ue', 'ü' => 'ue', 'Ö' => 'Oe', 'ö' => 'oe', 'ß' => 'ss', // Norwegian characters
